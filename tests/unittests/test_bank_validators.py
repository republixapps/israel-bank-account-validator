...
class TestBankValidators(unittest.TestCase):
    ...
    def test_mizrahi_validator(self):
        bank_validator = BANK_VALIDATORS[SUPPORTED_BANKS['MIZRAHI_TEFAHOT']]
        # Example from MASAV doc - Test reminder of 0, Account number: 160778, Branch number: 006, should be valid
        self.assertTrue(bank_validator(6, number_digits_to_list(160778, 9),
                                                                            number_digits_to_list(6, 3)))

        # Test reminder of 2, Account number: 160776, Branch number: 106, should be valid
        self.assertTrue(bank_validator(106, number_digits_to_list(160771, 9),
                                                                            number_digits_to_list(106, 3)))

        # Test reminder of 4, Account number: 160779, Branch number: 126, should be valid
        self.assertTrue(bank_validator(126, number_digits_to_list(160779, 9),
                                                                            number_digits_to_list(126, 3)))

        # Test invalid reminder 1, Account number: 160779, Branch number: 006, should be invalid
        self.assertFalse(bank_validator(6, number_digits_to_list(160779, 9),
                                                                             number_digits_to_list(6, 3)))

    def test_citybank_validator(self):
        bank_validator = BANK_VALIDATORS[SUPPORTED_BANKS['CITYBANK']]
        # Example from MASAV doc, Account number: 700241017, should be valid
        self.assertTrue(bank_validator(None, number_digits_to_list(700241017, 9), None))

        # Account number: 700241317, should be invalid
        self.assertFalse(bank_validator(None, number_digits_to_list(700241317, 9), None))

    def test_hsbc_validator(self):
        bank_validator = BANK_VALIDATORS[SUPPORTED_BANKS['HSBC']]
        ...
        self.assertTrue(bank_validator(101, number_digits_to_list(123456489, 9), None))

        # Account number: 123356789, branch: 101, should be invalid
        self.assertFalse(bank_validator(101, number_digits_to_list(123356789, 9), None))

        # For branch 102, account number should end with 001 control digits
        # Account number: 123456001, branch: 102, should be valid
        self.assertTrue(bank_validator(102, number_digits_to_list(123456001, 9), None))

        # Account number: 123456010, branch: 102, should be invalid
        self.assertFalse(bank_validator(102, number_digits_to_list(123456010, 9), None))

        # No special rules for other branches, Account number: 123356789, branch: 121, should be valid
        self.assertTrue(bank_validator(121, number_digits_to_list(123356789, 9), None))

        # No special rules for other branches, Account number: 123456010, branch: 121, should be valid
        self.assertTrue(bank_validator(121, number_digits_to_list(123456010, 9), None))

    def test_beinleumi_validator(self):
        bank_validator = BANK_VALIDATORS[SUPPORTED_BANKS['BEINLEUMI']]
        ...
        self.assertTrue(bank_validator(None, number_digits_to_list(132018, 9), None))

        # Test reminder = 0 on second rule, Account number: 007232017, should be valid
        self.assertTrue(bank_validator(None, number_digits_to_list(7232017, 9), None))

        # Test reminder = 6 on second rule, Account number: 006132018, should be valid
        self.assertTrue(bank_validator(None, number_digits_to_list(6132018, 9), None))

        # Test invalid, reminder = 7 on first and second rules, Account number: 000132019, should be invalid
        self.assertFalse(bank_validator(None, number_digits_to_list(132019, 9), None))

        # Test invalid, reminder = 7 on first rule, Account number: 007132019, should be valid
        self.assertFalse(bank_validator(None, number_digits_to_list(7132019, 9), None))

    def test_masad_validator(self):
        bank_validator = BANK_VALIDATORS[SUPPORTED_BANKS['MASAD']]
    ...
    def test_jerusalem_validator(self):
        ...
        self.assertTrue(bank_validator(None, number_digits_to_list(123456789, 9), None))

        # Account number: 987654321, should be valid
        self.assertTrue(bank_validator(None, number_digits_to_list(987654321, 9), None))

        # Account number: 111111111, should be valid
        self.assertTrue(bank_validator(None, number_digits_to_list(111111111, 9), None))

        # Account number: 22, should be valid
        self.assertTrue(bank_validator(None, number_digits_to_list(22, 9), None))

        # Account number: 3, should be valid
        self.assertTrue(bank_validator(None, number_digits_to_list(3, 9), None))
